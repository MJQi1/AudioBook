		...
		<scroll-view scroll-y="true" class="swiper-sccroll" @scrolltolower="loadMore">
			<view>
				<view class="swiper-container">
					...
					<!-- 图标快捷 -->
					<book-block :list="funList" @chooseSwiper="handleChooseSwiper"></book-block>
					<!-- 展示模块 -->
...
<script>
import { selectBar, rankData, textList, boyList, funList, pollDownData } from '../data.js';
...
export default {
	...
	methods: {
		...
		handleChooseSwiper(item) {
			uni.navigateTo({
				url:'/pages/home/classCheck/classCheck?type='+item
			})
		},
		//推荐更多
		mores() {
